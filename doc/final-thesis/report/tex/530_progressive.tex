...
\itodo{na imagem, trocar Update Radius para Radius Reduction}
\image[width=0.6\textwidth]{diagram_ppm}{High Level Fluxogram of Progressive Photon Mapping}{fig:diagram_ppm}
...
\begin{figure}
  ...
  \begin{subfigure}{.5\textwidth}
    \centering
    \includegraphics[width=.95\linewidth]{progressive_photon_mapping_step1}
    \caption{First step: Ray tracing \label{fig:ppm_step1}}
  \end{subfigure}%
  \begin{subfigure}{.5\textwidth}
    \centering
    \includegraphics[width=.95\linewidth]{progressive_photon_mapping_step2}
