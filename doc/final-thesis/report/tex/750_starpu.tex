...
\itodo{texto sobre o grafico cpu1/dm/dmda}

\image[width=0.6\textwidth]{profiling/starpu_cpu_dm_dmda}{\starpu implementation, \cpu sequential vs sequential schedulers}{fig:prof:starpu_cpu}
