...
\itodo{proença (sobre o paragrafo acima): só foi abordado o modelo de mem partilhada. E quando ha mem distribuida?}
...
\itodo{proença (sobre o paragrafo acima): uma feature mt importante num gpu que nao foi referida é o suporte a execução simlutanea de muitas threads, enquanto no cpu é mt limitado (ver intel o HT suporta 2 a 4 threads)}
...
\itodo{proença: mas os cpus usam outra abordagem para esconder a latencia da mem}
