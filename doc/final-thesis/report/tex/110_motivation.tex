...
\todo{ As an extra effort, an attempt to port the implementation to another co-processor device, particularly a \mic, is also attempted. While neither of the frameworks currently supports these devices, this is expected to change in the future}
