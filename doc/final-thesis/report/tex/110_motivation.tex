...
\itodo{why study a framework such as starpu? why photon mapping?}
...
\itodo{implement photon mapping in starpu, compare the performance to non-starpu implementations (also mine), and evaluate the framework, both in terms of performance, and also in terms of usability, from the perspective of a programmer, or a scientist}
