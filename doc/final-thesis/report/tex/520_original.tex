...
\image[width=0.5\textwidth]{diagram_pm}{High Level Flowchart of Photon Mapping}{fig:diagram_pm}
...
\itodo{ref para o diagrama}

\image[width=0.6\textwidth]{photon_mapping_step1}{Overview of the first step of Photon Mapping}{fig:pm_step1}
...
\image[width=0.6\textwidth]{photon_mapping_step2}{Overview of the second step of Photon Mapping}{fig:pm_step2}
