...
\begin{figure}[!htp]
  ...
  \end{subfigure}
  \caption[\starpu dependency management caveat]{Illustration of a possible mistake due to dependency management. Both A and B have read-only access to $x$ \label{fig:deps_problem}}
\end{figure}
