...
\item[dm (Deque Model)] Performs a HEFT-like strategy \itodo{citar aqui a tese do artur, e outros artigos sobre o heft}. Each task is assigned to where the scheduler thinks its termination time will be minimized;
