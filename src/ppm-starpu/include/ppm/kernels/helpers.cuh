...
__HD__ void sky_light_le      (Spectrum& const le, const Vector& dir, const SkyLight& sky_light);
__HD__ void sun_light_le      (Spectrum& const le, const Vector& dir, const SunLight& sun_light);
__HD__ void area_light_le     (Spectrum& const le, const Vector& wo, const Normal& light_normal, const AreaLightParam& mat);
...
__HD__ bool get_hit_point_information(PointerFreeScene* scene, Ray& ray, const RayHit& hit, Point& hit_point, Spectrum& surface_color);
...
__HD__ void generic_material_sample_f(const Material& mat, Vector& wo, Vector& wi, Spectrum& f, Normal& shade_N, const float u0, const float u1, const float u2, bool& specular_bounce);
...
__HD__ void alloy_material_sample_f(const AlloyParam& mat, const Vector& wo, Vector& wi, const Normal& shade_N, const float u0, const float u1, const float u, float& pdf, Spectrum& f, bool& specular_bounce);
